<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditUser.aspx.cs" Inherits="MisPrjoect3.EditUser" %>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <form id="form1" runat="server">
        <div style="width: 80%; margin:auto; margin-top: 5vh; margin-bottom: 5vh; border: 1px solid #00B4DA; border-radius: 1em; padding: 2%;">
          ...
          <div id=middle style="width: 44%; padding: 2%; float: left; display: inline; border-right: 1px solid #008eaa; border-left: 1px solid #008eaa;">
            ...
            <asp:TextBox style="width: 100%;" ID="salaryTextBox" runat="server" BorderStyle="Solid"></asp:TextBox>
              <br />
              <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="salaryTextBox" ErrorMessage="Must be a valid E-mail" ForeColor="Red" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
            <br />
            
            <asp:TextBox style="width: 100%;" ID="descTextBox" runat="server" BorderStyle="Solid"></asp:TextBox>
          </div>
