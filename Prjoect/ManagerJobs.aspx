<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManagerJobs.aspx.cs" Inherits="MisPrjoect3.ManagerJobs" %>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <form id="form1" runat="server">
        <div style="width:80%; margin:auto; margin-top: 5vh;">
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Database1ConnectionString %>" ProviderName="<%$ ConnectionStrings:Database1ConnectionString.ProviderName %>" SelectCommand="SELECT * FROM [current_jobs]"></asp:SqlDataSource>
            <asp:GridView style="width: 100%" ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="ID" DataSourceID="SqlDataSource1" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                <Columns>
                    ...
                    <asp:BoundField DataField="recruiterID" HeaderText="recruiterID" SortExpression="recruiterID" />
            ...
            <br />
            <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Edit Job" />
            <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Delete Job" />
        </div>
    </form>
</body>
</html>
