<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManagerLogin.aspx.cs" Inherits="MisPrjoect3.ManagerLogin" %>
...
<body>
    <form id="form1" runat="server">
        <div class="wrap-login100 p-t-50 p-b-50 p-l-20 p-r-20" style="margin:auto; margin-top:15vh;">
            <span class="login100-form-title p-b-51">
                manager
                Login
            </span>
            <div class="form-group">
                <asp:TextBox class="form-control input100" aria-describedby="emailHelp" placeholder="Name" ID="TextBox1" runat="server"></asp:TextBox>
